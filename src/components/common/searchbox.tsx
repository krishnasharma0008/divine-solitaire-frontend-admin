...
const SearchBox: React.FC<SearchBoxProps> = ({ options, selected, value, onChange, onSearchClick }) => {
  return (
    <div className="w-full flex justify-end !h-[44px] shadow-md rounded">
      <div className="border rounded-l-lg border-r-0 border-slate-200 bg-slate-100">
      ...
      <div className="!h-[45px] bg-[#00A0B6] border rounded-r-lg border-r-0 border-slate-200">
        <IconButton
          className="rounded bg-[#00A0B6] hover:shadow-[#00A0B6]/20 focus:shadow-[#00A0B6]/20 active:shadow-[#00A0B6]/10 border-none"
