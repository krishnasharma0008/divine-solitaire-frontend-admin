...
const SpecialProductsDetailReducer = (
  state: SpecialProductsDetail,
  action: SpecialProductsDetailAction
) => {
  if (action.type === "ALL") {
    return { ...state, ...(action.payload as unknown as SpecialProductsDetail) };
  }
